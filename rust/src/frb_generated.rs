...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1337195268;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__simple__set_governor_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__simple__set_swappiness_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__simple__set_vm_background_dirty_ratio_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__simple__set_vm_dirty_ratio_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
