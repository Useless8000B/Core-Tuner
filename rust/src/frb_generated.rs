...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1064293509;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__simple__get_cpu_temperature_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__simple__get_ram_info_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__get_swap_info_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__simple__set_governor_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
