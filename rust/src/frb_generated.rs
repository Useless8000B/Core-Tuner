...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 816406486;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__simple__get_battery_info_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__simple__get_battery_temperature_impl(ptr, rust_vec_len, data_len),
        3 => wire__crate__api__simple__get_cpu_frequencies_impl(ptr, rust_vec_len, data_len),
        4 => wire__crate__api__simple__get_cpu_temperature_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__simple__get_ram_info_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__get_swap_info_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
